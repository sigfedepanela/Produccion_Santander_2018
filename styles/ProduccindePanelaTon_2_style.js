...
var style_ProduccindePanelaTon_2 = function(feature, resolution){
    ...
    if (value >= 166.490000 && value <= 512.490000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 512.490000 && value <= 1240.410000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1240.410000 && value <= 2441.830000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2441.830000 && value <= 17730.290000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 17730.290000 && value <= 24756.100000) {
            style = [ new ol.style.Style({
